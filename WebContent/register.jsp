...
<div class="well well-small" style="margin-top: 12em;">
	...
	<div class="span9">
            ...
            <% if (session.getAttribute("duplicateEmail") != null && (Boolean) session.getAttribute("duplicateEmail")) { %>
            <p class="error"> duplicate email</p>	
            <% } %>
            ...
            <form id="register-form" class="form-horizontal" action="register" method="post">
                ...
                <div class="control-group">
                    ...
                    <div class="controls">
                      <input type="text" id="inputFname" placeholder="First Name" name="firstName">
                    </div>
                 </div>
                 <div class="control-group">
                    <label class="control-label" for="inputLname">Last name <sup>*</sup></label>
                    <div class="controls">
                      <input type="text" id="inputLname" placeholder="Last Name" name="lastName">
                    </div>
                 </div>
                <div class="control-group">
