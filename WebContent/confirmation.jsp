...
<!-- 				<a class="" href="index"> <span class="icon-home"></span> Home</a> 
...
<!-- 				<a href="#"><span class="icon-user"></span> My Account</a>  -->
				...
				<a class="" href="display"><span class="icon-shopping-cart"></span> 
				<% if (carts == null) { %>
				0 item
				
				<% } else { %>
				<span class="items-num">0</span>  item(s)
				<% } %>
				</a>				
...
<!--                     <tr>
                     ...
                     <tr>
                      <td colspan="4" class="alignR">Total price:	</td>
...
<!--         <a href="index.jsp" class="shopBtn btn-large"><span class="icon-arrow-left"></span> Continue Shopping </a>
        <a href="login.jsp" class="shopBtn btn-large pull-right">Check out <span class="icon-arrow-right"></span></a> -->
