		...
		<div class="well well-small">
			...
			<div class="row-fluid">
				<div class="span8">
					...
					<div class="">
						<a href="product_detail?name=<%= item.getName() %>" class="overlay"></a> <a
							href="product_detail?name=<%= item.getName() %>"><img
							src="<%= item.getImage_link() %>" alt=""></a>
				...
				<div class="span7">
					<h3><%= item.getName() %> [$<%= item.getPrice() %>]  Only <%= item.getQuantity() %> left in the stock</h3>
					<hr class="soft" />
